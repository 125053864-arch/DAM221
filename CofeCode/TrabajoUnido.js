...
function agregarProducto(){
    teclado.question("Nombre del producto: ", function(nombre){
        teclado.question("precio deel producto: ",function(precio){
            teclado.question("Descuento del producto: ",function(descuento){
                teclado.question("Esta disponible? (si/no): ",function(disponible){

            let producto = {
                nombre: nombre,
                precio: Number(precio)
                descuento: Number(descuento),
                disponible: disponible.toLowerCase()== "si"
...
//Copie y pegue el codigo de Cocina.js por que yo estaba trabajando en el codigo unido y no era asi 
